...
{
    public class TweakedImproveDefaultParams : Abstract
    {
        public TweakedImproveDefaultParams(GameClient pGame, bool liveGame, bool debugMode) : base(pGame, liveGame, debugMode)
        {
        }
